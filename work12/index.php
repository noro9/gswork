<?php
 ...
 ?>
  ...
  <!--[if gt IE 8]><!--> <html class="no-js" lang="ja"> <!--<![endif]-->
  	...
  	<title>Three/3 &mdash; サービス名</title>
  	...
  	<header id="fh5co-header" role="banner">
  		<div class="container">
  			<div class="header-inner">
  				<h1><a href="index.html">Three/3&nbsp;</a></h1>
  				<nav role="navigation">
  					<ul>
  						...
  						<li class="cta"><a href="shoplogin.php">お店の方</a></li>
  					</ul>
  				</nav>
  			</div>
  		</div>
  		   		...
  		   		<div class="container">
  		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
  		   				<div class="slider-text-inner">
  		   					<h2>noro9noro9</h2>
  		   					<p><a href="customer.php" class="btn btn-primary btn-lg">使ってみる</a></p>
  		   				</div>
  		   			</div>
  		   		</div>
  		   	</li>
